...
class UserProfileResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'name' => $this->name,
            'role' => $this->user->getAccount($request->input('account_id'))->pivot->roles[0]['name'],
            'permissions' => GetPermissionsResource::collection($this->user->getAccount($request->input('account_id'))->pivot->permissions),
